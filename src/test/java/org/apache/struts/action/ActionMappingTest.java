...
public class ActionMappingTest {
  ...
  void testActionCanReceiveActionFormAssignedInActionMapping() throws Exception {
    ...
    var controller = new StrutsActionController(actionConfig, app.appContext);
    var forward = controller.handleRequest(request, app.getResponse());
    assertNotNull(forward);
    assertEquals("forward:/exercise/html-link.do", forward.getViewName());
  }
}
