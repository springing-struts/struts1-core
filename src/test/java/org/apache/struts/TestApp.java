...
public class TestApp {
  ...
  public HttpServletRequest createRequest(
    ...
    request = HttpServletRequest.wrap(mockRequest);
    ...
    response = HttpServletResponse.wrap((jakarta.servlet.http.HttpServletResponse) mockResponse);
    return request;
  }
  ...
  public <T extends Tag> void assertTagContent(
    ...
    if (actionPath != null) {
      var moduleConfig = ModuleUtils.getInstance().getModuleConfig(HttpServletRequest.wrap(request));
