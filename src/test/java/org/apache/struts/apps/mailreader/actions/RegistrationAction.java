...
public final class RegistrationAction extends BaseAction {
   ...
   */
  private void errorUsernameUnique(String username, ActionMessages errors) {
    errors.add(USERNAME, new ActionMessage("error.username.unique", username));
  }
   ...
   * @throws ServletException On any error
   */
  private void doPopulate(User user, ActionForm form) throws ServletException {
    if (log.isTraceEnabled()) {
