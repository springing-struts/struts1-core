...
import static org.apache.struts.validator.FieldChecks.validateFloat;
import static org.assertj.core.api.AssertionsForClassTypes.assertThat;
import static org.mockito.Mockito.*;

@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
public class FieldChecksFloatTest {
  ...
  void shouldPass() {
    assertThat(
      validateFloat(mockBean, mockAction, mockField, mockErrors, mockValidator, mockRequest)
    ).isTrue();
  ...
  @Test
  void itRejectsFieldValuesThatCouldNotBeConvertedToFloat() {
    prepareFixture("aa");
    shouldReject();
