 ...
 */
public class ImgTag extends StrutsHtmlElementTagBase implements UrlBuilderBean {
  ...
  protected Map<String, String> getAdditionalAttributes() throws JspException {
    ...
    attrs.put("src", requireNonNullElseGet(src, () -> buildUrl(pageContext)));
  ...
  public void setAltKey(String altKey) {
    this.alt = ModuleUtils.getCurrent().getMessageResources().getMessage(altKey);
  }
  ...
  public void setSrcKey(String srcKey) {
    this.src = ModuleUtils.getCurrent().getMessageResources().getMessage(srcKey);
  }
