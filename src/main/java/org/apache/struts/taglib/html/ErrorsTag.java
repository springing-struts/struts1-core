 ...
 *   message text will end with `{@code <ul>}` to start the error messages list
 *   (default "errors.header").
 * - footer:
 *   Text that will be rendered after the error messages list. Typically, this
 *   message text will begin with `{@code </ul>}` to end the error messages list
