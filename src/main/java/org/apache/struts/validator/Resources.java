...
public class Resources {
  ...
  public static String getMessage(
    ...
    var validationName = validatorAction.getName();
    var args = getArgs(validationName, messages, locale, field);
    var message = validatorAction.getMsg();
    return messages.getMessage(locale, message, args);
  }
