...
import static springing.util.ServletRequestUtils.forwardRequest;
...
public class RequestProcessor implements ApplicationContextAware {
  ...
  protected boolean processForward(
    ...
    var forwardPath = mapping.getForwardPath();
    if (forwardPath == null) {
      return true;
    }
  ...
  protected void doInclude(
    ...
    forwardRequest(uri, request, response, true);
  }
  ...
  protected void doForward(
    ...
    forwardRequest(uri, request, response, false);
  }
