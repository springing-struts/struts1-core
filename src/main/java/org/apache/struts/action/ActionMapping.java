...
public class ActionMapping extends ActionConfig {
 ...
 /**
  ...
  /**
   * Returns the action mapping instance associated with the current request.
   */
  public static ActionMapping getCurrent() {
    return (ActionMapping) ServletRequestUtils.getCurrent().getAttribute(Globals.MAPPING_KEY);
  }
}
