...
public interface HttpServletResponse extends ServletResponse, jakarta.servlet.http.HttpServletResponse {
  ...
  static HttpServletResponse toJavaxNamespace(jakarta.servlet.http.HttpServletResponse response) {
    if (response instanceof HttpServletResponse inJavaxNamespace) {
