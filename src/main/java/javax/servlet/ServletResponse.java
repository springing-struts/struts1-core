...
public interface ServletResponse extends jakarta.servlet.ServletResponse {
  ...
  static ServletResponse toJavaxNamespace(jakarta.servlet.ServletResponse response) {
    if (response instanceof ServletResponse inJavaxNamespace) {
      return inJavaxNamespace;
    }
    if (response instanceof jakarta.servlet.http.HttpServletResponse httpServletResponse) {
      return HttpServletResponse.toJavaxNamespace(httpServletResponse);
    }
