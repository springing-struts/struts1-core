...
public class ObjectUtils {
  ...
  public static <T> T createInstanceOf(
    ...
    try {
      ...
      if (props != null) {
        if (instance instanceof DynaBean dynaBean) {
          setPropertiesToDynaBean(dynaBean, props);
        } else{
          setPropertiesToBean(clazz, instance, props);
        }
      }
      return instance;
  ...
  private static void setPropertiesToBean(Class<?> clazz, Object bean, Map<String, ?> props) {
