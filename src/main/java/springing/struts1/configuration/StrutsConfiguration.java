...
public class StrutsConfiguration {
  ...
  public MessageResources messageResources() {
    return MessageResources.getMessageResources();
  }

  @Bean
  @RequestScope
  public RequestProcessor requestProcessor() throws ServletException {
      ...
      for (var actionConfig : moduleConfig.getActionConfigs()) {
        ...
        mappings.registerMapping(mapping, (StrutsRequestProcessing) (request, response) -> {
          ...
          requestProcessor.process(
            ...
            HttpServletResponse.wrap(response)
          );
        }, PROCESS_METHOD);
      }
    }
  ...
  private interface StrutsRequestProcessing {
    void process(jakarta.servlet.http.HttpServletRequest request, jakarta.servlet.http.HttpServletResponse response) throws ServletException, IOException;
  }
