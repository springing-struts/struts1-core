...
public class WebAppConfiguration implements ServletContextInitializer {
  ...
  private void initApplicationScopeVariablesForModule(
    ServletContext servletContext, ModuleConfigBean module
  ) {
    var modulePrefix = module.getPrefix();
    servletContext.setAttribute(
      ValidatorPlugIn.VALIDATOR_KEY + modulePrefix, module.getValidatorResources()
    );
    servletContext.setAttribute(
      Globals.MESSAGES_KEY + modulePrefix, module.getMessageResources());
  }
