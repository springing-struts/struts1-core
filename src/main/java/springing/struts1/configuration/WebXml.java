...
public class WebXml {
  ...
  public void registerWelcomeFile(RequestMappingHandlerMapping mappings, ModuleConfigBean moduleConfig) {
    final String welcomeFilePath = findEffectiveWelcomeFilePathFor(moduleConfig);
  ...
  private @Nullable String findEffectiveWelcomeFilePathFor(ModuleConfigBean moduleConfig) {
